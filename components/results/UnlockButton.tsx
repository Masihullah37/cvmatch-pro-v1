  ...
  return (
    <>
      <button 
        ...
        disabled={loading}
        className="bg-primary text-primary-foreground px-8 py-6 rounded-full font-bold shadow-xl hover:shadow-primary/40 hover:scale-105 transition-all group flex items-center gap-3 text-lg disabled:opacity-50 disabled:cursor-not-allowed"
      >
        {loading ? (
